...
public class BuyTicketUseCaseConfiguration {
    @Bean
    public BuyTicketUseCase buyTicketUseCase(UserStore userStore, TicketStore ticketStore, BuyTicketValidator validator) {
        return new BuyTicketUseCase(userStore, ticketStore, validator);
    }
}
